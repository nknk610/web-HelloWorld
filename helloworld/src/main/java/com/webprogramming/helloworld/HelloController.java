...
public class HelloController 
{
    ...
    public String CalculateAdd(String param1, String param2)
    {
    ...
    public String CalculateSubtract(String param1, String param2)
    {
        float num1 = 0f, num2 = 0f;
        try
        {
    ...
    public String CalculateMultiply(String param1, String param2)
    {
        float num1 = 0f, num2 = 0f;
        try
        {
    ...
    public String CalculateDivide(String param1, String param2)
    {
        float num1 = 0f, num2 = 0f;
        try
        {
